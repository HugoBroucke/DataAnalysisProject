...
The French names are very varied, from the classic frist name to the original first name. But what is the origin of French first names? In the following article we want to study variations of French first names and show that they often translate the major French events.
...
You can find a summary of our project [here](https://www.youtube.com/watch?v=I3ItDhnvbdo&feature=youtu.be&fbclid=IwAR3lmYsDMx1JSrAf_Jc2aCBOz1v-h3na8IHqy8tVpEB6mtfYj7A6E_ta5qw).
...
These articles have given us avenues to explore. We decided to check and explain the appearance of these names through our database.
...
In this report can understand that the first names French illustrates the history of France. We have seen that the geopolitical context, but also the cultural events have an impact on the popularity of French first names.

Future work can be done on other countries to see the events that impact the popularity of first names.
